...
<div class="row search-content desktop" style="width: 100vw; height: 100vh; background-image: url('{{ asset('img/templ3.png') }}'); background-size: cover;">
...
<!-- PROVA RESP MD -->
<div class="row search-content tablet" style="width: 100vw; height: 100vh; background-image: url('{{ asset('img/templ4.png') }}'); background-size: cover;">
    <div class="titolo-ski-rent">
        <h2 style="text-shadow: 2px 2px 2px grey">SKI RENT</h2>
        <p style="color: #fff; text-shadow: 2px 2px 2px grey">
            Consegna e ritiro a domicilio in meno di 24h del materiale che decidi di noleggiare
...
<!-- PROVA RESP MOBILE -->
<div class="row search-content mobile" style="width: 100vw; height: 100vh; background-image: url('{{ asset('img/templMobile.png') }}'); background-size: cover;">
    <div class="titolo-ski-rent">
        <h2 style="text-shadow: 2px 2px 2px grey">SKI RENT</h2>
        <p style="color: #fff; text-shadow: 2px 2px 2px grey">
            Consegna e ritiro a domicilio in meno di 24h del materiale che decidi di noleggiare
